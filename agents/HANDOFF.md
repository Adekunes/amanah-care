...
- **Business model (owner's spec, 10:05):** `pitch/BUSINESS.md` (French, English summary at the end). Positioning; pricing grid (families free and unlimited, voluntary support $3 to $5 for extras only, agencies and care organisations $300 per elder per year on one invoice, community organisations about $600 a year to sponsor 50 families on the free Family tier, self-hosting open source with support from $150 a month); capacity math for the 1 million CPU-hours a year target (114 cores; 19,000 to 150,000 active families, estimates); break-even N = C ÷ p (40 elders cover the $1,000 server, 200 cover $5,000); retention levers; what we will not do; risks. Deck slide 9, backup A3, qa.html and explainer §12 follow it.
